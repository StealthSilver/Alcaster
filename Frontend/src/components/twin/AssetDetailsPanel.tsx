...
export function AssetDetailsPanel({
  ...
  const results = useMemo(
    () => (query.trim().length >= 2 ? searchAssets(model, query, 8) : []),
    [model, query],
  );
  ...
  return (
    <div className="flex w-[236px] flex-col gap-2">
      ...
      <div className="max-h-[min(52vh,420px)] overflow-y-auto rounded-xl border border-edge-strong bg-page/90 px-3 py-2.5 backdrop-blur-sm">
