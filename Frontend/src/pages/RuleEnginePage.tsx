      ...
      actions={
        projectId ? (
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to={projectDataExplorerPath(projectId)}
            ...
            <Link
              to={`${projectDataEntryPath(projectId)}?product=rule-engine`}
