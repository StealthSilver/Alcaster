...
export function AuthPage({ mode }: AuthPageProps) {
  ...
  return (
    <div className="relative flex h-svh items-center justify-center overflow-hidden bg-[#010609] px-4 py-3 font-sans text-fg antialiased">
      <AsciiWindscape />

      <div className="relative z-10 w-full max-w-[420px]">
        <Link
          to="/signin"
          className="mb-4 flex flex-col items-center gap-2 drop-shadow-[0_2px_16px_rgba(0,0,0,0.85)]"
        >
          <AlcasterLogo onDark className="h-10 w-auto" width={91} height={41} />
          <span className="text-sm font-semibold tracking-[0.18em] text-white">
            ALCASTER
          </span>
        </Link>

        <div className="rounded-md border border-edge bg-surface/90 p-4 shadow-[var(--alcaster-shadow)] backdrop-blur-[2px]">
